...
public class MetricasService {
    ...
    // ---------- HU36 / HU38: insumos mas y menos utilizados / resumen ----------
    ...
    /** Tabla resumen de insumos consumidos, ordenada alfabeticamente (HU38). */
    public List<MetricaInsumo> obtenerResumenInsumosConsumidos(int restauranteId) {
        List<MetricaInsumo> metricas = calcularConsumoInsumos(restauranteId);
        metricas.sort(Comparator.comparing(MetricaInsumo::getNombre, String.CASE_INSENSITIVE_ORDER));
        return metricas;
    }

    public List<MetricaInsumo> obtenerResumenGeneralInsumos() {
        return obtenerResumenInsumosConsumidos(TODOS_LOS_RESTAURANTES);
    }
